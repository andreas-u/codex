...
CREATE UNIQUE INDEX setting_object_slug_idx ON setting_object (slug, setting_id);
...
CREATE INDEX setting_object_tags_btree_idx ON setting_object_tags USING BTREE (setting_object_id, tag);
